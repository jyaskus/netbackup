...
default['netbackup']['rhel'] = {
  ...
  client_base_url: 'https://mvnrepo.nordstrom.net/nexus/content/repositories/thirdparty/symantec/com/netbackup_client_redhat/7.5.0.7',
  ...
  client_patch_url: 'https://mvnrepo.nordstrom.net/nexus/content/repositories/thirdparty/symantec/com/netbackup_client_redhat/7.5.0.7',
  ...
  client_appliance_url: 'https://mvnrepo.nordstrom.net/nexus/content/repositories/thirdparty/symantec/com/netbackup_client_redhat/7.6.1.1',
...
default['netbackup']['solaris2'] = {
  ...
  client_base_ver: '7.5',
  client_base_dir: 'NetBackup_7.5_CLIENTS',
  client_base_url: 'https://mvnrepo.nordstrom.net/nexus/content/repositories/thirdparty/symantec/com/netbackup_client_solaris/7.5',
  ...
  client_patch_url: 'https://mvnrepo.nordstrom.net/nexus/content/repositories/thirdparty/symantec/com/netbackup_client_solaris/7.5.0.7',
  ...
  client_appliance_url: 'https://mvnrepo.nordstrom.net/nexus/content/repositories/thirdparty/symantec/com/netbackup_client_solaris/7.6.1.1',
